...
<app-form-modal [open]="modalOpen" [title]="editingId ? 'Editar produto' : 'Novo produto'" (close)="closeModal()">
  <div class="grid grid-3">
    ...
    <div><label>Marca</label><input [(ngModel)]="form.brand"></div>
...
<div class="card table-wrap"><table><thead><tr><th>Código</th><th>Descrição</th><th>Marca</th><th>Unidade</th><th>Preço geral</th><th>Desc. máx.</th><th>Estoque</th></tr></thead>
...
export class ProductsComponent implements OnInit {
  ...
  load() { this.api.get<any[]>('/products').subscribe({ next:(r)=>this.rows=r, error:e=>this.error=formatApiError(e.error?.detail) }); }
